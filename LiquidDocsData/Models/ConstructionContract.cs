...
public class ConstructionContract : IPartyNames
{
    ...
    public LiquidDocsData.Enums.ConstructionContracts.EntityType ConstructionEntityType { get; set; } = LiquidDocsData.Enums.ConstructionContracts.EntityType.Contractor;
