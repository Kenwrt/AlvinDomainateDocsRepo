...
public static class DocumentOutputEvaluator
{
    ...
    /// </summary>
    public static IReadOnlyList<LiquidDocsData.Models.DTOs.DocumentListDTO> BuildFinalDocumentSet(
        LoanType loanType,
        IReadOnlyDictionary<string, object?> data,
        Func<Guid, LiquidDocsData.Models.DTOs.DocumentListDTO?> resolveDtoById)
    {
        ...
        var result = new List<LiquidDocsData.Models.DTOs.DocumentListDTO>(ids.Count);
